<h2><a href="https://leetcode.com/problems/password-strength">Password Strength</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given a string <code>password</code>.</p>
